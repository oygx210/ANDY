...
Bar1Damper.setProp(U.b*eye(3,3),Bar1.BaseFrame.getTransSym(1));
Bar2Damper=SB.genDamper({'Bar2Damper' 3 1});
Bar2Damper.setProp(U.b*eye(3,3),Bar2.BaseFrame.getTransSym(1));
Bar3Damper=SB.genDamper({'Bar3Damper' 3 1});
Bar3Damper.setProp(U.b*eye(3,3),Bar3.BaseFrame.getTransSym(1));
