...
Sim=sAxes('PassiveWalker Simulator',3,'Path_PassiveWalker.mat',@TF_PassiveWalker_mex);
...
LiFootTraj.setLineSpec('--','y',2).setTimedPlotPoint('LiFoot');
LoFootTraj.setLineSpec('--','c',2).setTimedPlotPoint('LoFoot');
InnerPose.setLineSpec('-','r',3).setPlotPoint({'BodyFrame';'LiKnee';'LiFoot'});
OuterPose.setLineSpec('-','b',3).setPlotPoint({'BodyFrame';'LoKnee';'LoFoot'});
