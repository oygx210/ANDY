...
World2Torso.setAngVel([qrx.dot(0);qry.dot(0);qrz.dot(0)],'s_tr').setTransDis([qtx.dot(0);qty.dot(0);qtz.dot(0)]).simpProp;
Torso2TailRoll.setDH([0;-pi/2;C.d_t;-pi/2]).simpProp;
TailRoll2TailYaw.setDH([0;q_TR.dot(0);0;pi/2]).simpProp;
TailYaw2TailCOM.setDH([0;q_TY.dot(0);C.l_t;0]).simpProp;
...
Torso2LFH.setAxang(sym([-pi/2;1;0;0])).setTransDis(0.5*[-C.b_w;C.b_l;0]).simpProp;
LFH2LFT.setDH([0;pi/2+q_LF_H.dot(0);0;-pi/2]).simpProp;
LFT2LFS.setDH([0;q_LF_T.dot(0);C.l_th;0]).simpProp;
LFS2LFF.setDH([0;q_LF_S.dot(0);C.l_sh;0]).simpProp;
LFT2LFTCOM.setDH([0;q_LF_T.dot(0);0.5*C.l_th;0]).simpProp;
LFS2LFSCOM.setDH([0;q_LF_S.dot(0);0.5*C.l_sh;0]).simpProp;
...
Torso2RFH.setAxang(sym([-pi/2;1;0;0])).setTransDis(0.5*[C.b_w;C.b_l;0]).simpProp;
RFH2RFT.setDH([0;pi/2-q_RF_H.dot(0);0;-pi/2]).simpProp;
RFT2RFS.setDH([0;q_RF_T.dot(0);C.l_th;0]).simpProp;
RFS2RFF.setDH([0;q_RF_S.dot(0);C.l_sh;0]).simpProp;
RFT2RFTCOM.setDH([0;q_RF_T.dot(0);0.5*C.l_th;0]).simpProp;
RFS2RFSCOM.setDH([0;q_RF_S.dot(0);0.5*C.l_sh;0]).simpProp;
...
Torso2LRH.setAxang(sym([-pi/2;1;0;0])).setTransDis(0.5*[-C.b_w;-C.b_l;0]).simpProp;
LRH2LRT.setDH([0;pi/2+q_LR_H.dot(0);0;-pi/2]).simpProp;
LRT2LRS.setDH([0;q_LR_T.dot(0);C.l_th;0]).simpProp;
LRS2LRF.setDH([0;q_LR_S.dot(0);C.l_sh;0]).simpProp;
LRT2LRTCOM.setDH([0;q_LR_T.dot(0);0.5*C.l_th;0]).simpProp;
LRS2LRSCOM.setDH([0;q_LR_S.dot(0);0.5*C.l_sh;0]).simpProp;
...
Torso2RRH.setAxang(sym([-pi/2;1;0;0])).setTransDis(0.5*[C.b_w;-C.b_l;0]).simpProp;
RRH2RRT.setDH([0;pi/2-q_RR_H.dot(0);0;-pi/2]).simpProp;
RRT2RRS.setDH([0;q_RR_T.dot(0);C.l_th;0]).simpProp;
RRS2RRF.setDH([0;q_RR_S.dot(0);C.l_sh;0]).simpProp;
RRT2RRTCOM.setDH([0;q_RR_T.dot(0);0.5*C.l_th;0]).simpProp;
RRS2RRSCOM.setDH([0;q_RR_S.dot(0);0.5*C.l_sh;0]).simpProp;

System.Space.plotGraph(1);
System.Space.makeKinematics();