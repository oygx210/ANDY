...
%% Declare Damper
System.genDamper({'SystemDamper' numel(System.Model.Continuous)/2 1})...
.setProp(sym(u_SYS.u_b*eye(numel(System.Model.Continuous)/2,numel(System.Model.Continuous)/2))...
        ,System.Model.Continuous(numel(System.Model.Continuous)/2+1:end));
...
LFFixFootPointExpr=jSimplify(LegLFFoot.rootTransDis()-[p_LF.p_LF_X;p_LF.p_LF_Y;0]);
...
RFFixFootPointExpr=jSimplify(LegRFFoot.rootTransDis()-[p_RF.p_RF_X;p_RF.p_RF_Y;0]);
...
LRFixFootPointExpr=jSimplify(LegLRFoot.rootTransDis()-[p_LR.p_LR_X;p_LR.p_LR_Y;0]);
...
RRFixFootPointExpr=jSimplify(LegRRFoot.rootTransDis()-[p_RR.p_RR_X;p_RR.p_RR_Y;0]);
